 ...
 * its first payload byte is the packed command being acknowledged.  ACK
 * target decoding is generic (for example A/4 -> 0xA8, DriverState 9/3 ->
 * 0x96).  A normal A/4 frame is the separate EVK response path.
